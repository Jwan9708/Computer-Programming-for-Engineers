...
int main()
{
    ...
    cout << short_size << "(shrt) " << int_size << "(int) " << long_size << "(long) " << float_size << "(float) " << double_size << "(double) " << long_double_size << "(long double) " << char_size << "(char) " << bool_size << "(bool) " << int16_size << "(int16) " << uint32_size << "(unit32) " << int64_size << "(int64) " << longlong_size << "(long long) " << endl; 
    return 0;
}